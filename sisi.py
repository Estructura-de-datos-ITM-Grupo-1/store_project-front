...
def main():
    ...
    img_base64 = get_base64("fondo.jpg")  # Asegúrate de tener fondo.jpg en el mismo directorio
    ...
    st.markdown(f"""
        ...
        .right-panel h2, .input label, .login-button, .support-container, .support-button, input[type="email"], input[type="password"] {{
            z-index: 2;
        }}
        .right-panel h2 {{
            font-size: 24px;
    ...
    # Esta estructura reemplaza las columnas de Streamlit y permite un layout limpio
    st.markdown(f"""
